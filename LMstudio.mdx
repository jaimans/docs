---
title: 'LMstudio'
description: 'Integrate with LMstudio to use OpenSesame when running LLMs locally'
---

Before proceeding ensure you have [LMstudio](https://lmstudio.ai) installed and the local server is running.
