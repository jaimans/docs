...
- **Real-Time Testing**: Activate Testing Mode by clicking the play button in purple on the side of the entry box. This lets you input prompts or actions for your agent to process individually, allowing you to see each response in real time.
